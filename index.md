...
<section class="container home-categories" aria-label="Rokomari promo code categories">
  ...
  <ul class="category-link-grid">
    <li><a href="{{ '/rokomari-book/' | relative_url }}">📚 বইয়ের Rokomari promo code</a> – উপন্যাস, ইসলামিক, একাডেমিক, মোটিভেশনালসহ সব বই ক্যাটাগরি।</li>
    ...
    <li><a href="{{ '/rokomari-gorer-bazar/' | relative_url }}">🏠 গৃহস্থালি / গোরের বাজার</a> – ডেইলি প্রয়োজনীয় সব জিনিসে সেভ করার সুযোগ।</li>
    ...
    <li><a href="{{ '/best-seller/' | relative_url }}">🔥 Best Seller Rokomari promo code</a> – সব ক্যাটাগরির সবচেয়ে বেশি বিক্রি হওয়া পণ্যের বাছাই অফার।</li>
  </ul>
</section>
